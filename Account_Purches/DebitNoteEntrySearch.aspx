<%@ Page Title="" Language="C#" MasterPageFile="~/Import_MasterPage/eRoyalMasters.master"
    AutoEventWireup="true" CodeFile="DebitNoteEntrySearch.aspx.cs" Inherits="DebitNoteEntrySearch" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="innerbox_MidMain" style="height: 105px;">
        <div id="tag_srcinner1">
            <div id="newbu">
                <input type="submit" value="Submit" class="new" onclick="open_DebitNote_N('New'); return false" />
            </div>
            <div id="verslic">
            </div>
            <div id="editbu">
    ...
    <div id="innerbox_MidMain_Grid" style="height: 580px; margin-top: -13px;">
        <div id="Main_Grid_Container" runat="server" style="overflow: hidden;">
            <asp:GridView runat="server" ID="gvdetails" EmptyDataText="NO RECORD FOUND" AutoGenerateColumns="false"
               ...
               OnRowCreated="gvdetails_RowCreated" OnRowDataBound="gvdetails_RowDataBound" DataKeyNames="DEBITNOTE_MAIN_ID,DEBITNOTE_NO"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="DEBITNOTE_NO" HeaderText="DebitNote No" HeaderStyle-HorizontalAlign="Left"
                        HeaderStyle-Width="280px">
                        <ItemStyle CssClass="column_style_left5" HorizontalAlign="Left" Width="280px" Font-Size="12px" />
                    </asp:BoundField>
                    <asp:BoundField DataField="DEBITNOTE_DATE" HeaderText="Date" HeaderStyle-HorizontalAlign="Center"
                        HeaderStyle-Width="80px">
                        <ItemStyle CssClass="column_style_left5" HorizontalAlign="Left" Width="80px" Font-Size="12px" />
                    </asp:BoundField>

                     <asp:BoundField DataField="FILE_REF_NO" HeaderText="FileRefNo" HeaderStyle-HorizontalAlign="Left"
                        HeaderStyle-Width="280px">
                        <ItemStyle CssClass="column_style_left5" HorizontalAlign="Left" Width="280px" Font-Size="12px" />
                    </asp:BoundField>

                     <asp:BoundField DataField="DR_CR" HeaderText="CR/ DR" HeaderStyle-HorizontalAlign="Left"
                        HeaderStyle-Width="280px">
                        <ItemStyle CssClass="column_style_left5" HorizontalAlign="Left" Width="280px" Font-Size="12px" />
                    </asp:BoundField>
