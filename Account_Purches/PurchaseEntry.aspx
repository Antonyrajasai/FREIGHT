<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PurchaseEntry.aspx.cs"    Inherits="PurchaseEntry" %>
    ...
    <asp:ScriptManager ID="ScriptManager1" runat="server" EnablePartialRendering="false"
        LoadScriptsBeforeUI="false" EnablePageMethods="true">
            ...
            <div id="innerbox_MidMain" style="height: 150px;">
                    ...
                    <div id="tag_transac_lft_in2" style="margin-top: 5px;">
                        ...
                        <div id="tag_label_transact_Src" style="width: 110px;">
                            Working period &nbsp;&nbsp;
                              ...
                              <div id="txtcon-m_Exchange" style="width: 194px;">
                ...
                <div id="tag_transact_src_inner" style="width: 1350px;height:120px;">
                    <div id="tag_Exchange_inner_lft" style="width: 1350px;height:120px;">
                        <div id="tag_transact_lft_in1" style="width: 1300px; height:120px;">                            
                            <div style="width: 1400px; height: 40px">
                                <div id="txt_container_Transact_Main_l" style="width:245px;">
                                    <div id="tag_label_transact_Src" style="width: 100px;">
                                        Voucher No
                                    </div>
                                    <div id="txtcon-m_Exchange" style="width:125px;" >
                                        <asp:TextBox ID="txtVoucherno_ps" CssClass="txtbox_none_Mid_transac_code" Width="125px" Enabled="false" runat="server"></asp:TextBox>
                            ...
                            <cc1:CalendarExtender ID="CalendarExtender1" runat="server" TargetControlID="txtVoucherdate"
                                PopupButtonID="txtJobDate" Enabled="true" Format="dd/MM/yyyy">
                                    ...
                                    <div id="txtcon-m_Exchange" style="width:180px;height:400px;position:absolute;margin-left:325px;" >
                                    <asp:DropDownList ID="ddlVendorname" runat="server" class="chosen-select-deselect" ClientIDMode="Static"
                                        ...
                                        TabIndex="3" Width="180px"  ></asp:DropDownList>
                                        
                                    </div>
                                    <div id="tag_label_transact_Src" style="width: 200px;">
                                    ...
                                    <div id="txtcon-m_Exchange" style="width: 150px">
                                         ...
                                         <asp:DropDownList ID="ddlVendorBranch" CssClass="listtxt_transac_item_gen_notn" Width="150px" AutoPostBack="true"
                                ...
                                <div  id="txt_container_Transact_Main_l"  style="width: 1450px; height: 28px;" >
                                    ...
                                    <div id="txtcon-m_Exchange" style="width: 145px">
                                        <asp:TextBox ID="txtVendorstate" CssClass="txtbox_none_Mid_transac_code"  style="width: 125px" Enabled="false" TabIndex="4" runat="server"></asp:TextBox>
                                    </div>
                           ...
                           <div style="width: 1400px; height: 30px">                             
                                    ...
                                    <div id="txtcon-m_Exchange" style="width: 145px;">
                                        <asp:TextBox ID="txtVendorbillno" AutoPostBack="true" OnTextChanged="txtVendorbillno_TextChanged" CssClass="validate[required] txtbox_none_Mid_transac_code" style="width: 125px;" TabIndex="9" runat="server"></asp:TextBox>
                                    </div>
                            ...
                            <cc1:CalendarExtender ID="CalendarExtender2" runat="server" TargetControlID="txtBilldate"
                                PopupButtonID="txtJobDate" Enabled="true" Format="dd/MM/yyyy">
                                    ...
                                    <div id="txtcon-m_Exchange" style="width: 110px;">
                                        <asp:TextBox ID="txtInvoiceCurrency"  runat="server" ClientIDMode="Static"  TabIndex="11"    onchange="Calculationex();" onkeypress="return char1(event)"  MaxLength="3" CssClass="validate[required,minSize[3],custom[onlyLetterSp]] txtbox_none_Mid_transac_code" ></asp:TextBox>
                                    </div>
                                    ...
                                    <div id="txtcon-m_Exchange" style="width: 110px;">
                                        <asp:TextBox ID="txtExrate"  runat="server" Enabled="true"   TabIndex="12"
                                    ...
                                    <div id="txtcon-m_Exchange"  style="width: 90px; ">
                                        ...
                                        TabIndex="13" MaxLength="50"  ></asp:TextBox>
                                    ...
                                    <div id="txtcon-m_Exchange" style="width: 150px;">
                                        <asp:TextBox ID="txtTotalamtininr" Enabled="true"  runat="server" TabIndex="13" ClientIDMode="Static" 
            ...
            <div class="content" id="page-1" style="margin-top: -30px;">
                ...
                <div id="innerbox_MidMain_Trans_new" style="height: 240px; width: 1300px; margin-left: -16px; overflow-y:scroll; overflow-x:scroll;
                    ...
                    <asp:TemplateField HeaderText="Imp_Exp">
                        <ItemTemplate>
                            <asp:DropDownList ID="drpImpexp" Width="59px" SelectedValue='<%# Eval("Imp_Exp") %>' onchange="drpimpexp(this)" AppendDataBoundItems="true"     runat="server" >
                                   ...
                                   <asp:ListItem Text="FF AE" Value="Exp FW Air"></asp:ListItem>
                                     <asp:ListItem Text="FF SE" Value="Exp FW Sea"></asp:ListItem>
                                        <asp:ListItem Text="CL AE" Value="Exp CL Air"></asp:ListItem>
                                          ...
                                          <%-- <asp:ListItem Text="CC AE" Value="Exp CC Air"></asp:ListItem>
                                            <asp:ListItem Text="CC SE" Value="Exp CC Sea"></asp:ListItem>--%>
                          <%--  <asp:ListItem >Imp FW Air</asp:ListItem>
                            ...
                            <asp:ListItem >Imp CC Air</asp:ListItem>
                            <asp:ListItem >Imp CC Sea</asp:ListItem>
                            ...
                            <asp:ListItem >Exp CL Air</asp:ListItem>
                              <asp:ListItem >Exp CL Sea</asp:ListItem>
                               <asp:ListItem >Exp CC Air</asp:ListItem>
                            <asp:ListItem >Exp CC Sea</asp:ListItem>--%>
                    ...
                    <asp:TemplateField HeaderText="JobNo" HeaderStyle-Width="90px">
                        <ItemTemplate>
                            <asp:TextBox ID="txtJOBNO" runat="server"    AutoPostBack="false"  onchange="cusname(this)" onfocusout="cusname(this)" Text='<%# Eval("JobNo") %>'   Width="150px" CssClass=" Fileref" ></asp:TextBox>
                    ...
                    <asp:TemplateField HeaderText="Credit">
                        <ItemTemplate>
                            ...
                            style="text-align:right;" 
                                        CssClass="validate[custom[number]] creditgst"  onfocusout="Calculation(this)"
                                        onblur="extractNumber(this,5,false);remove_zero_after_decimal_point(this.value,'txtbillamount');"
                                        onkeyup="extractNumber(this,5,false);return Clear_Dot(this);"
                    ...
                    <asp:TemplateField HeaderText="TDS">
                        <ItemTemplate>
                            <asp:TextBox ID="txtgTds" runat="server" Enabled="true" onfocusout="Calculationtds(this)" style="text-align:right;"  
                                        CssClass="validate[custom[number]] "
                                        onblur="Calculationtds(this);extractNumber(this,5,false);remove_zero_after_decimal_point(this.value,'txtbillamount');"
                                        onkeyup="extractNumber(this,5,false);return Clear_Dot(this);"
                                        onkeypress="return blockNonNumbers(this, event, true, false);" Text='<%#Eval("TDS","{0}") %>' Width="60px"></asp:TextBox>
                        </ItemTemplate>
                         <ItemStyle Width="60px" />
                         <FooterTemplate>
...
<div id="tag_label_transact_Src" style="width: 90px;">
            ...
            <div id="innerbox_MidMain_bot_transact" runat="server" style="height: 20px;">
                ...
                <div id="newbu">
                              <asp:Button ID="btnNew" runat="server"  OnClick="btnNew_Click" CssClass="new"
                             TabIndex="35" />
                    </div>
                    <div id="newbu">
...
<asp:Button ID="btn" runat="server" TabIndex="94" OnClick="btnDelete_Click" CausesValidation="false"
...
//                    alert($(".debitgst")[rowIndex].val());
//                    if ($(".debitgst")[rowIndex].val() != null && $(".debitgst")[rowIndex].val() != '') {

                    var txtAmountReceive = $(".debitgst")
                    var txtAmountReceivec = $(".creditgst")
                    if (txtAmountReceive[rowIndex].value != null && txtAmountReceive[rowIndex].value != '' && txtAmountReceive[rowIndex].value!='0.00') {
                            var a = txtAmountReceive[rowIndex].value;}

//                    }
//                    else if ($(".creditgst")[rowIndex].val() != null && $(".creditgst")[rowIndex].val() != '') {

                        else if (txtAmountReceivec[rowIndex].value != null && txtAmountReceivec[rowIndex].value != '' && txtAmountReceivec[rowIndex].value != '0.00') {
                            var a = txtAmountReceivec[rowIndex].value;
                        }
...
//                    var a = txtAmountReceive[rowIndex].value;
                    ...
                    if (a != null && a != '') {
                        ...
                        $("#txtNetamt").val(Nettotal.toFixed(2))
...
//                txtdtsamt[rowIndex].value = tdsamt;
                ...
                if (totalcredit != null && totaldebit != null && totalcredit != '' && totaldebit != '') {
                    ...
                    if (curr == 'INR') {
                        grandtotal = Math.round(parseFloat(totalcgst) + parseFloat(totalsgst) + parseFloat(totaligst) - parseFloat(totalcredit))
                        Nettotal = Math.round(parseFloat(totalcgst) + parseFloat(totalsgst) + parseFloat(totaligst) - parseFloat(totaltds) - parseFloat(totalcredit))
                    }
                    else {
                        grandtotal = parseFloat(totalcgst) + parseFloat(totalsgst) + parseFloat(totaligst) - parseFloat(totalcredit)
                        Nettotal = parseFloat(totalcgst) + parseFloat(totalsgst) + parseFloat(totaligst) - parseFloat(totaltds) - parseFloat(totalcredit)
                    }
                }
                else if (totaldebit != null && totaldebit != '') {
                    if (curr == 'INR') {
...
//                
            ...
            function cusname(lnk) {
                ...
                var Working_period = $('#<%= ddlworking_Period.ClientID %>').val();
//                if (a != "") {
//                    a.ReadOnly = true;
...
//                var b = '1';
                $('#Hd_row_id').val(rowIndex);
                Cha_cus(a, b, Working_period);
            }
            function Cha_cus(src, dest, Working_period) {
          
                PageMethods.Cust_Name(src, dest, '', Working_period, CallSuccess_Cusname, CallFaileda, dest );
            }
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("[id*=txtJOBNO]").autocomplete({
                source: function (request, response) {
                    var field = $(this.element).attr('id');
                    var dimpexp = $("[id*=drpImpexp]");
                    var Working_Period = $('#<%= ddlworking_Period.ClientID %>').val();
                 
                    $.ajax({

                        url: "../AutoComplete_Pages/Auto_Complete_Searching.asmx/purchase_Imp_Exp_List_DB",
                        //                        data: "{ 'mail': '" + request.term + "' ,'Imp_Exp':'" + $("[id*=drpImpexp]").val() + "'}",
                        data: "{ 'mail': '" + request.term + "' ,'Imp_Exp':'" + dimpexp[document.getElementById("Hd_row_id").value].value + "' ,'Working_Period': '" + Working_Period + "'}",
 ...
 <script type="text/javascript">
     ...
     function CallSuccess_Cha_exrate(res) {
         ...
         if (res != '') {
             ...
             document.getElementById("txtTotalamtininr").value = (Bill_Amt * res).toFixed(0);
         }
