<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReceiptEntry.aspx.cs" Inherits="ReceiptEntry" %>
            ...
            <div id="innerbox_MidMain" style="height: 95px;">
                <div id="tag_srcinner1">
                    ...
                    <div id="tag_transac_lft_in2" style="margin-top: 5px;">
                        <div id="txtcon-m_Exchange" style="width: 180px; display:none; ">
                            <asp:RadioButtonList ID="Rd_Job_Type" runat="server" RepeatDirection="Horizontal"
                                AutoPostBack="false" OnSelectedIndexChanged="Rd_Job_Type_SelectedIndexChanged">
                ...
                <div id="tag_transact_src_inner" style="width: 1300px">  <%-- style="width: 1150px" --%>   
                    <div id="tag_Exchange_inner_lft" style="width: 1300px">
                            ...
                            <div style="width: 1400px; height: 150px">
                                ...
                                <div id="txt_container_Transact_Main_l">
                                    ...
                                    <div id="txtcon-m_Exchange">
                                       <%-- <asp:RadioButtonList ID="RdPayFor" runat="server" RepeatDirection="Horizontal" TabIndex="1">
                                            <asp:ListItem Text="Bill" Value="Job" Selected="True"></asp:ListItem>
                                            <asp:ListItem Text="AdvPayment" Value="Advance"></asp:ListItem>
                                        </asp:RadioButtonList>    --%>  
                                        <asp:DropDownList ID="ddlPayFor" CssClass="listtxt_transac_item_gen_notn" Width="162px"
                                            runat="server" TabIndex="1" AutoPostBack="false">    <%--onchange="ddlValidation_ddlModeofPay(this.value);"--%>
                                            <%--<asp:ListItem>--Select--</asp:ListItem>--%>
                                            <asp:ListItem Value="Job">Bill</asp:ListItem>
                                            <asp:ListItem Value="Advance">AdvPayment</asp:ListItem>                                           
                                        </asp:DropDownList>
                                    </div>
                                </div>
                                <div id="txt_container_Transact_Main_l" style="width:340px">
                                    <div id="tag_label_transact_Src" style="width: 110px;">
                                        Payment From
                                    </div>
                                    <div id="txtcon-m_Exchange" style="width:63px">
                                        <asp:DropDownList ID="ddlPaymentfrom" CssClass="listtxt_transac_item_gen_notn" Width="62px"
                                            runat="server" TabIndex="1" AutoPostBack="false">                                             
                                            <asp:ListItem >Party</asp:ListItem>
                                            <asp:ListItem >Staff</asp:ListItem>                                           
                                        </asp:DropDownList>
                                    </div>
                                    <div id="txtcon-m_Exchange" style="width:80px">
                                        <asp:DropDownList ID="ddlCustomer" CssClass="listtxt_transac_item_gen_notn" Width="160px"
                                            runat="server" TabIndex="2" AutoPostBack="true" OnSelectedIndexChanged="ddlCustomer_SelectedIndexChanged">
                                        </asp:DropDownList>
                                    </div>
                                </div>
                                <div id="txt_container_Transact_Main_l" style="width:220px">
                                    ...
                                    <div id="txtcon-m_Exchange" style="width: 85px">
                                        <asp:DropDownList ID="ddlbranch_No" CssClass="listtxt_transac_item_gen_notn" Width="162px"
                                            runat="server" TabIndex="3" AutoPostBack="true" OnSelectedIndexChanged="ddlbranch_No_SelectedIndexChanged">
                                        </asp:DropDownList>
                                    </div>
                                </div>
                                ...
                                <div id="txt_container_Transact_Main_l" style="width:300px">
                                    ...
                                    <div id="txtcon-m_Exchange" style="width: 85px">
                                    <%--  OnSelectedIndexChanged="ddlModeofPay_SelectedIndexChanged" --%>
                                ...
                                <div id="txt_container_Transact_Main_l">
                                    ...
                                    <div id="txtcon-m_Exchange">
                                        <asp:DropDownList ID="ddlDepositInBank" AutoPostBack="true"
                                            CssClass="listtxt_transac_item_gen_notn" Width="162px"
                                            runat="server" TabIndex="2" 
                                            onselectedindexchanged="ddlDepositInBank_SelectedIndexChanged"  >
                                        </asp:DropDownList>
                                    </div>
                                </div>
                                ...
                                <div id="txt_container_Transact_Main_l" style="width:340px">
                                    ...
                                    <div id="txtcon-m_Exchange" style="width:200px">
                                        <asp:TextBox ID="txtBankReceiptNo" runat="server" CssClass="txtbox_none_Mid_transac_code" MaxLength="100" Width="200px" TabIndex="3"></asp:TextBox>
                                    </div>
                                </div>
                                <div id="txt_container_Transact_Main_l" style="width:220px">
                                    ...
                                    <div id="txtcon-m_Exchange" style="width:140px">
                                        <asp:TextBox ID="txtReceiptNo" runat="server" CssClass="txtbox_none_Mid_transac_code" Width="135px" MaxLength="100" TabIndex="3"></asp:TextBox>
                                    </div>
                                </div>
                                <div id="txt_container_Transact_Main_l">
                                    <div id="tag_label_transact_Src" style="width: 110px;">
                                    ...
                                    <div id="txtcon-m_Exchange" style="width: 85px">
                                        <asp:TextBox ID="txtDate" runat="server" Width="152px" MaxLength="10" CssClass="txtbox_none_Mid_transac_code"
                ...
                <div id="innerbox_MidMain_Trans_new" style="height: 450px; width: 1290px; margin-left: -16px;
                    ...
                    <ol id="toc_new">
                        ...
                        <li><a href="#page-7" onclick="jQuery('#form1').validationEngine('hideAll');B_G_tab_page2('0');"
                            id="Page_B" runat="server"  onserverclick="RDBillInvNo_CheckedChanged" ><span>Receipt History</span></a></li>
                        ...
                        <div id="pop_text_area_transac_popup_inn_container_export" style="height: 380px;
                            ...
                            <div id="tag_transact_src_inner" style="width: 1150px; height: 200px;">
                                <div id="tag_Exchange_inner_lft" style="width: 1000px">
                                    ...
                                    <div id="pop_text_area_transac_popup_inn_container_rght_new">
                                        <div id="txt_container_Transact_Main_l">
                                            <div id="tag_label_transact_Src" style="width: 500px; margin-top: -150px">
                                                Narration:
                                    ...
                                    <asp:GridView ID="gv_Chg_Details" runat="server" AllowSorting="True" EmptyDataText="No Record Found"
                                        ...
                                        <Columns>
                                            <asp:TemplateField HeaderText="" HeaderStyle-Font-Bold="true" HeaderStyle-Width="30px">
                                                <ItemTemplate>
                                                    <asp:CheckBox ID="chk_inv" runat="server" HeaderText="chkSelect" Width="30px" Checked ="true" Visible="false"  />
                                            ...
                                            <asp:TemplateField HeaderText="Branch" HeaderStyle-Font-Bold="true" HeaderStyle-Width="100px">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtUser_BranchName" CssClass="underlined" placeholder="Enter Branch"
                                            ...
                                            <asp:TemplateField HeaderText="Bill No" HeaderStyle-Font-Bold="true" HeaderStyle-Width="100px">
                                                <ItemTemplate>                                                                                                
                                               <%-- <asp:Label ID="lblBill_inv_No" runat="server" Text='<%# Eval("Bill_inv_No") %>' Visible = "false" />
                                                    <asp:DropDownList ID="ddlBill_inv_No" 
                                                        runat="server" Height="20px" Width="100px" Font-Size="12px" CssClass="chosen-select-deselect">
                                                    </asp:DropDownList>   --%>

                                                   <%-- <asp:TextBox ID="txtBill_inv_No" CssClass="underlined" placeholder="Enter Bill No"
                                                        runat="server" Height="20px" Width="100px" Font-Size="12px" ReadOnly="false"></asp:TextBox> --%>

                                                    <asp:TextBox ID="txtBill_inv_No" CssClass="underlined billinv" placeholder="Enter Bill No"  
                                                    runat="server" Height="20px" Width="140px" Font-Size="12px" Text='<%# Bind("BILL_INV_NO") %>' ClientIDMode="Static" AutoPostBack="false"  onfocusout="Bill_Details_Finder(this)"  ></asp:TextBox>
                                                    
                                                </ItemTemplate>
                                                <ItemStyle Width="140px" />
                                            </asp:TemplateField>

                                            <asp:TemplateField HeaderText="BillFor" HeaderStyle-Font-Bold="true" HeaderStyle-Width="100px">
                                                <ItemTemplate>                                                                                                
                                               

                                                    <asp:TextBox ID="txtBill_For" CssClass="underlined"   
                                                    runat="server" Height="20px" Width="140px" Font-Size="12px" Text='<%# Bind("BillFor") %>' ClientIDMode="Static" AutoPostBack="false"    ></asp:TextBox>
                                           ...
                                           <%-- <asp:BoundField DataField="Bill_inv_date" HeaderStyle-Font-Bold="true" DataFormatString="{0:dd/MM/yyyy}"
                                                HeaderText="Bill Date" HeaderStyle-Width="70px">
                                            ...
                                            <asp:TemplateField HeaderText="Bill Date" HeaderStyle-Font-Bold="true" HeaderStyle-Width="70px">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtBill_inv_date" CssClass="underlined" placeholder="" runat="server" ReadOnly="false"
                                           ...
                                           <%-- <asp:BoundField DataField="JobNo" HeaderStyle-Font-Bold="true" HeaderText="Job No"
                                                HeaderStyle-Width="50px">
                                                <ItemStyle CssClass="column_style_left5" HorizontalAlign="Left" Width="90px" Font-Size="11px" />
                                            </asp:BoundField>    --%>

                                            <asp:TemplateField HeaderText="Job No" HeaderStyle-Font-Bold="true" HeaderStyle-Width="70px">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtJOBNO" CssClass="underlined" placeholder="" runat="server" ReadOnly="false" Text='<%# Bind("JOBNO") %>'
                                                        Height="20px" Width="70px" Font-Size="12px" ></asp:TextBox>
                                                </ItemTemplate>
                                                <ItemStyle Width="70px" />
                                            </asp:TemplateField>

                                           <%-- <asp:BoundField DataField="Imp_Exp" HeaderStyle-Font-Bold="true" HeaderText="I/E"
                                                HeaderStyle-Width="50px">
                                                <ItemStyle CssClass="column_style_left5" HorizontalAlign="Left" Width="90px" Font-Size="11px" />
                                            </asp:BoundField> --%> 
                                            
                                            <asp:TemplateField HeaderText="I/E" HeaderStyle-Font-Bold="true" HeaderStyle-Width="25px">
                                                <ItemTemplate>
...
<%--                                            <asp:BoundField DataField="Total_Amt_Tax" HeaderStyle-Font-Bold="true" HeaderText="Bill Amount"
...
--%>
                                            <asp:TemplateField HeaderText="Bill Amount" HeaderStyle-Font-Bold="true" HeaderStyle-Width="70px">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtBillAmt" CssClass="underlined" placeholder="" runat="server" ReadOnly="false"
...
<%--                                           <asp:BoundField DataField="ReceivedAmt" HeaderStyle-Font-Bold="true" HeaderText="Already Received"
                                                HeaderStyle-Width="70px">
                                                <ItemStyle CssClass="column_style_left5" HorizontalAlign="Left" Width="90px" Font-Size="11px" />
                                            </asp:BoundField>--%>

                                            <asp:TemplateField HeaderText="Already Received" HeaderStyle-Font-Bold="true" HeaderStyle-Width="70px">
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Balance Amount" HeaderStyle-Font-Bold="true" HeaderStyle-Width="100px">
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Current Receivable" HeaderStyle-Font-Bold="true" HeaderStyle-Width="100px">
                                                <ItemTemplate>
...
<%--                                                    <asp:MaskedEditExtender ID="MaskedEditExtender1" runat="server" TargetControlID="txtTDSDate"
                                            ...
                                            <asp:TemplateField HeaderText="TDS %" HeaderStyle-Font-Bold="true" HeaderStyle-Width="50px">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtTDSPercent" CssClass="underlined" placeholder="Enter%" runat="server"
                ...
                <%--//////////////////////////////////////////////////////////////////////////////--%>
                                            <asp:TemplateField>
                                                <ItemTemplate>
                                                    <%-- OnCommand="gv_Chg_Details_RowDeleting"  --%>
                         ...
                         <div  class="content"  id="page-7"  style="display:none;height:440px;" >
                            ...
                            <style type="text/css">
                             ...
                             <div id="tag_transac_lft_Item_maindet_Grid_area" style="overflow: auto; height: 305px;
                                 ...
                                 <asp:GridView runat="server" ID="gvReceiptdetails" EmptyDataText="NO RECORD FOUND"
                                     AutoGenerateColumns="true" CssClass="grid-view" ShowHeader="true" ShowHeaderWhenEmpty="false"
                                     Width="100%"   OnRowDataBound="gvReceiptdetails_RowDataBound"
     ...
     <div id="tag_transact_lft_in1" style="width: 1150px">
                           ...
                           <div id="txt_container_Transact_Main_l"   style="width: 270px;">
                              ...
                              <div id="txt_container_Transact_Main_l" style="width: 300px">
                                <div id="tag_label_transact_Src" style="width: 175px">
                                 Total Received:
                                </div>
                                <div id="txtcon-m_Exchange" style="width: 120px">
            ...
            <div id="innerbox_MidMain_bot_transact" runat="server" style="height: 20px;">
                <div id="innerbox_transac_bot_inn">
                    ...
                    <div id="editbu">
                        <asp:Button ID="btnSave" runat="server" CssClass="save" OnClientClick="return validate_Rec();"
                    ...
                    <div id="editbu">
                        <asp:Button ID="btnUpdate" runat="server" CssClass="updates" OnClick="btnUpdate_Click"
                            OnClientClick="return validate_Rec();" TabIndex="21" />
                    </div>
                    <div id="editbu">
                        <asp:Button ID="btnDelete" runat="server" TabIndex="23" CausesValidation="false"
                            UseSubmitBehavior="false" CssClass="dlete" OnClientClick="jQuery('#form1').validationEngine('hideAll');jConfirm('Delete this Receipt?', 'Receipts', function(r) {
                  var i = r + 'ok';
          if(i == 'trueok')
          {
            ...
            <asp:HiddenField ID="Hd_row_id" runat="server" />     <%--//from purchase based--%>
        </ContentTemplate>
    </asp:UpdatePanel>
    </form>
            ...
            $(".billinv").autocomplete({
                source: function (request, response) {
                      ...
                      var TempddlCustomer = document.getElementById("<%=ddlCustomer.ClientID %>").value;
                        ...
                        $.ajax({
                        url: "../Billing_Imp/ReceiptEntry.aspx/LoadPendingJob_webmethod",
                        type: "POST",
...
<script type="text/javascript">
    $(document).ready(function () {
        var ddl = document.getElementById("ddlModeofPay").value;        
        ddlValidation_ddlModeofPay(ddl);
    });
        function ddlValidation_ddlModeofPay(value) {
            if (value == 'Cheque') {
                $("#PnlNetBank").attr('disabled', true);
                $("#PnlCheque").attr('disabled', false);
                $("#PnlCash").attr('disabled', true);

                document.getElementById("txtNetBank").value = '';
                document.getElementById("txtNetBranch").value = '';
                document.getElementById("txtNetAmt").value = '';
                document.getElementById("txtNetRefno").value = '';
                document.getElementById("txtNetRefDt").value = '';

                $("#txtChqNo").attr('disabled', false);
                $("#txtChqDate").attr('disabled', false);
                $("#txtChqAmt").attr('disabled', false);
                $("#txtChqBank").attr('disabled', false);
                $("#txtChqBranch").attr('disabled', false);
            }
                ...
                $("#txtChqNo").attr('disabled', true);
                $("#txtChqDate").attr('disabled', true);
                $("#txtChqAmt").attr('disabled', false);
                $("#txtChqBank").attr('disabled', true);
                $("#txtChqBranch").attr('disabled', true);
            }
