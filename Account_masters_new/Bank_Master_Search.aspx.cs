...
public partial class Account_masters_new_Bank_Master_Search : ThemeClass
{
    ...
    protected void gvdetails_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        {
            string values = this.gvdetails.DataKeys[e.Row.RowIndex]["BANK_ID"].ToString();
            e.Row.Attributes["onmouseover"] = "this.style.cursor='pointer';";
            e.Row.Attributes.Add("onclick", "open_bankmaster_Upd('" + values + "')");
        }
    }
