<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Accounts_Debit_Note.aspx.cs" Inherits="Accounts_Accounts_Debit_Note" %>
            ...
            <div id="innerbox_MidMain_Billing" style="height: 95px;">
                <div id="tag_srcinner1" style="margin-left:0px">
                    ...
                    <div id="tag_transac_lft_in2" style="margin-top: 5px;">
                        ...
                        <div id="txtcon-m_Exchange" style="width: 215px;">
                    ...
                    <div id="tag_transac_lft_in2" style="margin-top: 5px;">
                        <div id="txtcon-m_Exchange" style="width: 265px;">
                    ...
                    <div id="verslic" style="margin-top: 5px;">
                     ...
                     <%-- <div id="verslic" style="margin-top: -3px;">
                    </div>--%>
                    <div id="popupwindow_closebut_right_new" style="margin-top: -1px;">
                ...
                <div id="tag_transact_src_inner" style="width: 1220px; height: 55px;">
                    <div id="tag_Exchange_inner_lft" style="width: 1220px">
                        <div id="tag_transact_lft_in1" style="width: 1220px; height: 30px;display:none">
                        ...
                        <div id="txtcon-m_Exchange" style="width: 50px;">
                            ...
                            <%--<asp:DropDownList ID="ddl_tr_mode" CssClass="listtxt_transac_item_gen_notn" Font-Size="12px"
                              ...
                              <div id="txtcon-m_Exchange" style="width: 150px">
                            <asp:DropDownList ID="ddlType" runat="server" TabIndex="4" onselectedindexchanged="ddlType_SelectedIndexChanged" AutoPostBack="true">
                                        <asp:ListItem>FORWARDING</asp:ListItem>
                                        <asp:ListItem>CLEARING</asp:ListItem>
...
--%>                                <%--<asp:DropDownList ID="ddlshipment_type" CssClass="listtxt_transac_item_gen_notn"
                               ...
                               <%-- </div>--%>
                                ...
                                <asp:ListItem Text="" Value="0"></asp:ListItem>                               
                                 ...
                                 <div id="tag_label_transact_Src" style="width: 133px;">
                                     <asp:RadioButtonList ID="Rdbbillseztype" TabIndex="18" runat="server" RepeatDirection="Horizontal">
         ...
         <div class="content" id="page-1" style="margin-top:-28px;">
          ...
          <div id="innerbox_MidMain_Trans_new" style="height:440px; width:1220px; margin-left:-16px; margin-top:-5px;">
                <ol id="toc_new">
                    ...
                    <div   class="content" id="page-6"  >
                        <div id="pop_text_area_transac_popup_inn_container_export" style="height:690px;margin-top: -16px; margin-left:-18px; color:Red;">
                            <div id="Div_listbox" runat="server">
                                <div id="tag_transact_src_inner" style="width: 1220px; height: 250px;">
                                    <div id="innerbox_MidMain_Trans_new" style="width: 1220px; height: 20px; margin-left: -10px;
                    ...
                    <div id="tag_Exchange_inner_lft" style="width: 1085px">
                        <div id="tag_transact_lft_in1" style="width: 1085px">
                            <div id="txt_container_Transact_Main_l">
                                ...
                                <div id="txtcon-m_Exchange" > 
                                  <asp:TextBox ID="txtDebitNo" runat="server" MaxLength="17" onkeyup="autotab(this);" ClientIDMode="Static" onblur="return ChangeCase(this);"
              ...
              <div class="content" id="page-8">
                      ...
                      width: 1220px; margin-top: -10px; margin-left: -18px;">
                    ...
                    <div  class="content"  id="page-7"  style="display:none;height:440px;" >
                           <div id="tag_transac_lft_Item_maindet_Grid_area" style="overflow: auto; height: 30px;
                                ...
                                <asp:GridView ID="GV1" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                    ...
                                    HorizontalAlign="Left" ShowHeaderWhenEmpty="True" Width="1115px" OnRowCreated="GV_RowCreated"
                           ...
                           <div id="tag_transac_lft_Item_maindet_Grid_area" style="overflow: auto; height: 30px;
                            ...
                            <div id="tag_transac_lft_Item_maindet_Grid_area"    style="overflow:auto; height:305px; width:1115px;margin-top:-10px;margin-left:-18px; ">
                             <asp:GridView ID="gv_Chg_Details" runat="server" AllowSorting="True" EmptyDataText="No Record Found"
                                    ...
                                    HorizontalAlign="Left" ShowHeaderWhenEmpty="True" Width="1115px"
                    ...
                    <div id="innerbox_transac_bot_inn" style="width:1050px">
                        ...
                        <div id="editbu">
                            <asp:Button ID="btnDelete" runat="server" TabIndex="121" CausesValidation="false"
                                UseSubmitBehavior="false" CssClass="dlete" OnClientClick="jQuery('#form1').validationEngine('hideAll');jConfirm('Delete this Invoice?', 'DEBIT NOTE DETAILS', function(r) {
                  var i = r + 'ok';
          if(i == 'trueok')
          {
              ...
              document.getElementById('btn').click();
                       ...
                       <div id="editbu" style="width:10px;"></div>
                        <div id="editbu" style="padding-top:5px;">
                            <asp:Button ID="btnrpt" runat="server" tabindex="125" Visible="true" Text="Get Bill" OnClientClick="return Get_Debit_Note_rpt_new();"  /> <%--OnClientClick="return Import_Billing_Job_Rpt('B');"--%> 
                        </div>
