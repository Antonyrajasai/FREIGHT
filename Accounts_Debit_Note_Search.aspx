<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Accounts_Debit_Note_Search.aspx.cs" MasterPageFile="~/MasterPage/eRoyalFreightMasters.master" Inherits="Accounts_Accounts_Debit_Note_Search" %>
...
<div id="tag_srcinner1" >
                <div id="newbu">
                    <input type="submit" value="Submit" class="new" onclick="open_Account_Debit_New('New'); return false" />
                </div>
                ...
                <%--  <div id="verslic"> </div>--%>
                     <div id="editbu" style="padding-top:3px;visibility:visible;">
                      <asp:ImageButton ID="btnexcel" runat="server"   ImageUrl="~/images/xls.jpg"  Height="28px" Width="28px"  OnClientClick="EXcel('D')"/>
                </div>
                <div id="editbu" style="padding-top:3px;">
                    ...
                    <asp:LinkButton ID="LinkButton1" runat="server" Height="28px" Width="28px"  OnClientClick="EXcel('DS')">Statement</asp:LinkButton>
                </div>
                    ...
                    <div id="tag_Exchange_inner_lft">
                        ...
                        <asp:CheckBox ID="chkqs" onclick = "MutExChkList(this);" runat="server" />
                          ...
                          <div id="txtcon-m_src" style="width: 100px;">
                               ...
                               <asp:ListItem Text="Inv. no" Value="DEBIT_INV_NO" ></asp:ListItem>
                               <asp:ListItem Text="Debit no" Value="DEBIT_NO" ></asp:ListItem>
                               </asp:DropDownList>
                            </div>
            ...
            <div id="Main_Grid_Container" runat="server" >  
                <asp:GridView runat="server" ID="gvdetails" EmptyDataText="NO RECORD FOUND" AutoGenerateColumns="false"
                    CssClass="grid-view" ShowHeader="true" ShowHeaderWhenEmpty="true" Width="100%"
                     OnRowDataBound="gvdetails_RowDataBound" CellPadding="1" DataKeyNames="ID,IMP_EXP,BILL_INV_NO,DEBIT_NO,TYPE"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="DEBIT_NO" HeaderText="Debit No"  HeaderStyle-Width="170px">
                       ...
                       <asp:BoundField DataField="BILL_INV_NO" HeaderText="Job No(Invoice No)"  HeaderStyle-Width="120px">
                        ...
                        <asp:BoundField DataField="DEBIT_DATE" HeaderText="Debit Date"  HeaderStyle-Width="80px">
