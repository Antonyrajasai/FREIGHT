...
public partial class Accounts_Accounts_Debit_Note_Search : ThemeClass
{
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        if (chkqs.Checked == true && ddltype.SelectedItem.Value != "0" && txtsearch.Text != string.Empty)
        {
            ...
            dss = BP.DEBIT_INV_GRID_SEARCH(ObjUBO);
    ...
    protected void gvdetails_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            string Invoice_No = this.gvdetails.DataKeys[e.Row.RowIndex]["DEBIT_NO"].ToString();
            string TYPE = this.gvdetails.DataKeys[e.Row.RowIndex]["TYPE"].ToString();
            e.Row.Attributes["onmouseover"] = "this.style.cursor='pointer';";
            e.Row.Attributes.Add("ondblclick", "open_Account_Debit_Update('" + ID + "','" + IMP_EXP + "','" + Invoice_No + "','" + TYPE + "')");
    ...
    private void Load_Grid()
    {
        ...
        ds1 = BP.DEBIT_INV_GRID_SEARCH(ObjUBO);
