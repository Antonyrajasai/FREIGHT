<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Airline_Wise_Profit_lOSS.aspx.cs" Inherits="Accounts_Airline_Wise_Profit_lOSS" MasterPageFile="~/MasterPage/eRoyalFreightMasters.master"%>
...
<div id="tag_label_transact_Src" style="width: 85px;">
                            ...
                            <asp:Label ID="lblList" runat="server" Text="CarrierName"></asp:Label>
                            </div>
                              <div id="tag_label_transact_Src" style="width: 100px;">
                                       ...
                                       <asp:DropDownList ID="ddlSearch" runat="server" TabIndex="4" style="width: 100px;">
                                        ...
                                        <asp:ListItem>Shippingline</asp:ListItem>
                                       </asp:DropDownList>
                                    </div>
                ...
                <asp:GridView runat="server" ID="gvdetails" EmptyDataText="NO RECORD FOUND" AutoGenerateColumns="false"
                    ...
                    <asp:BoundField DataField="JOBNO">
                        ...
                        <asp:BoundField DataField="CONSIGNEENAME" HeaderText="Consignee" >
                         ...
                         <asp:BoundField DataField="Shippingline" HeaderText="ShippingLine" >
                            <ItemStyle CssClass="column_style_left5"  />
                        </asp:BoundField>
