<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Bank_Master_Search.aspx.cs" MasterPageFile="~/MasterPage/eRoyalFreightMasters.master" Inherits="Account_masters_new_Bank_Master_Search" %>
            ...
            <div>
                <div id="innerbox_MidMain">
                    <div id="tag_srcinner1">
                        <div id="newbu">
                            <input type="submit" value="Submit" class="new" onclick="open_bankmaster_N(); return false"
                            ...
                            <div id="tag_transact_lft_in1">
                                <div id="txt_container_Transact_Main_l">
                                    ...
                                    <div id="txtcon-m_Exchange">
                                              <asp:TextBox ID="txtBank_name" runat="server" CssClass="txtbox_none_Mid_transac_src"
                ...
                <div id="innerbox_MidMain_Grid">
                    ...
                    <div id="tag_srcinner1grid_table_Container">
                        <div id="Main_Grid_Container">
                            <asp:GridView runat="server" ID="gvdetails" DataKeyNames="BANK_ID" AutoGenerateColumns="False"
