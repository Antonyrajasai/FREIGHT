<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GST_Imp_Exp_Invoice_Job.aspx.cs" Inherits="GST_Imp_Exp_Invoice_Job" %>
        ...
        <ContentTemplate>
            ...
            <div id="innerbox_MidMain_Billing" style="height: 95px;">
                <div id="tag_srcinner1">
                    <div id="mainmastop2container_rght_tag2_txt1" style="width: 108px; margin-left: 0px;">
                        I GST Bill Entry
                    </div>
                      <div id="verslic" style="margin-top: -5px;">
                    </div>
                    <div id="tag_transac_lft_in2" style="margin-top: 5px;">
                        <div id="txtcon-m_Exchange" style="width: 155px;">
                    ...
                    <div id="tag_transac_lft_in2" style="margin-top: 5px;">
                        <div id="txtcon-m_Exchange" style="width: 110px;">
                            Working period &nbsp;&nbsp;
                              ...
                              <div id="txtcon-m_Exchange" style="width: 194px; height:28px; overflow: auto;">
                    ...
                    <div id="popupwindow_closebut_right_new" style="margin-top: -2px;">
                ...
                <div id="tag_transact_src_inner" style="width: 1086px; height: 55px;">
                    <div id="tag_Exchange_inner_lft" style="width: 1085px">
                        <div id="tag_transact_lft_in1" style="width: 1085px; height: 30px;display:none">
                            ...
                            <div id="txt_container_Transact_Main_l" style="width: 580px;">
                                ...
                                <div id="txtcon-m_Exchange" style="width: 90px;display:none;">
                                 <asp:DropDownList ID="ddlContainerTypes1" CssClass="listtxt_transac_item_gen_notn" Font-Size="12px"
                        ...
                        <div id="tag_transact_lft_in1" style="width: 1100px;">
                            <div id="txt_container_Transact_Main_l" style="width: 1300px;">
                            ...
                            <asp:DropDownList ID="ddlType" runat="server" TabIndex="4" Width="135px">
                                        <asp:ListItem>FORWARDING</asp:ListItem>
                                        <asp:ListItem>CLEARING</asp:ListItem>
                                ...
                                <div id="txtcon-m_Exchange" style="width: 90px;">
                                 <asp:DropDownList ID="ddl_tr_mode" CssClass="listtxt_transac_item_gen_notn" Font-Size="12px"
                                Width="80px" TabIndex="5" runat="server" onselectedindexchanged="ddl_tr_mode_SelectedIndexChanged" AutoPostBack="true">
                                <asp:ListItem Text="--Select--" Value=""></asp:ListItem>
                                <asp:ListItem Text="Air" Value="Air"></asp:ListItem>
                                <asp:ListItem Text="Sea" Value="Sea"></asp:ListItem>
                                <%--<asp:ListItem Text="Other" Value="Other"></asp:ListItem>--%>
                                <%--<asp:ListItem Text="Land" Value="Land"></asp:ListItem>--%>
                                  ...
                                  <div id="txt_container_Transact_Main_l" style="width: 100px; margin-top: -1px;">
                                <div id="tag_label_transact_Src" style="width: 70px;">
                                  From Cha
                                </div>
                                <div id="txtcon-m_Exchange" style="width: 30px;">
                                    <asp:CheckBox ID="Chk_Cha" runat="server" TabIndex="6"  OnCheckedChanged="Chk_Cha_Type_CheckedChanged" AutoPostBack="True"  />
                                </div>
                            </div>
                            ...
                            <div id="tag_label_transact_Src" style="width: 50px; color:Green; font-weight:bold;">
                               Job No</div>
                              <div id="txtcon-m_transaction_Inv_No" style="width: 155px">
                             <asp:DropDownList ID="ddlJobno_N" runat="server" class="chosen-select-deselect" onChange="Jobno_Inv();" ClientIDMode="Static"
                                         
                                        TabIndex="7" Width="140px"  ></asp:DropDownList>
                                 </div>
                            ...
                            <%--<div id="tag_label_transact_Src" style="width: 50px; color:Green; font-weight:bold;">
                                    ...
                                    <div id="txtcon-m_Exchange" style="width: 150px;">
                                        <asp:TextBox ID="txt_Jobno" runat="server" CssClass="txtbox_none_Mid_transac_Inv_No" ClientIDMode="Static" Width="140px" MaxLength="20" TabIndex="8"> </asp:TextBox>
                                    </div>
                                     <div id="txtcon-m_Exchange" style="width: 85px;">
                                           <asp:Button ID="btn_Addjobno" TabIndex="9" runat="server" Width="80px"  CausesValidation="false" UseSubmitBehavior="false"
...
--%>                                <%--<asp:DropDownList ID="ddlshipment_type" CssClass="listtxt_transac_item_gen_notn"
                               ...
                               <%-- </div>--%>
                                ...
                                <asp:ListItem Text="" Value="0"></asp:ListItem>                               
                                 ...
                                 <div id="tag_label_transact_Src" style="width: 113px;">
                                    <asp:Button ID="btnloadData" TabIndex="9" runat="server" Width="100px" 
                                        Height="20px" Text="Load Data" onclick="btnloadData_Click" />
                                </div>

                                 <div id="tag_label_transact_Src" style="width: 123px;">
                                     <asp:RadioButtonList ID="Rdbbillseztype" TabIndex="10" runat="server" RepeatDirection="Horizontal">
                                ...
                                <div id="tag_label_transact_Src" style="width: 70px;display:none">
                                      <asp:Label ID="lblshiptype2" runat="server" Text=" Ship Type"></asp:Label>
                                  
                                </div>
                                <div id="tag_label_transact_Src" style="width: 100px;display:none">
                                    <asp:TextBox ID="ddlshipment_type2" Font-Size="12px" CssClass="txtbox_none_Mid_transac_Inv_No" Width="100px" TabIndex="22" runat="server"></asp:TextBox>
                              ...
                              <%--  <div id="tag_label_transact_Src" style="width: 95px;">
                                    ...
                                    <div id="txtcon-m_Exchange" style="width: 100px;">
                                         <asp:DropDownList ID="ddlshipment_type" CssClass="listtxt_transac_item_gen_notn" Font-Size="12px"
                                Width="90px" TabIndex="15" runat="server">
                                <asp:ListItem Text="" Value=""></asp:ListItem>
                                <asp:ListItem Text="FCL" ></asp:ListItem>
                                <asp:ListItem Text="LCL" ></asp:ListItem>
                            ...
                            <div id="tag_transact_lft_in1" style="width: 1100px;">
                               ...
                               <div id="tag_label_transact_Src" style="width: 95px;">
                                    ...
                                    <div id="txtcon-m_Exchange" style="width: 118px;">
                                         <asp:DropDownList ID="ddlshipment_type" CssClass="listtxt_transac_item_gen_notn" Font-Size="12px"
                                Width="90px" TabIndex="11" runat="server">
                                <asp:ListItem Text="" Value=""></asp:ListItem>
                                <asp:ListItem Text="FCL" ></asp:ListItem>
                                <asp:ListItem Text="LCL" ></asp:ListItem>
                            ...
                            <div id="tag_label_transact_Src" style="width: 100px;">
                                    ...
                                    <div id="txtcon-m_Exchange" style="width: 100px;">
                                        <asp:TextBox ID="txtconttype" runat="server" CssClass="txtbox_none_Mid_transac_Inv_No" ClientIDMode="Static" Width="90px" MaxLength="20" TabIndex="12"> </asp:TextBox>
                                    </div>
                            </div>
                        </div>
         ...
         <div class="content" id="page-1" style="margin-top:-28px;">
          ...
          <div id="innerbox_MidMain_Trans_new" style="height:440px; width:1260px; margin-left:-16px; margin-top:-5px;">
                <ol id="toc_new">
                  ...
                  <%----------------------------General---------------------------------------------------%>
                        ...
                        <div id="pop_text_area_transac_popup_inn_container_export" style="height:690px;margin-top: -16px; margin-left:-18px; color:Red;">
                            <div id="Div_listbox" runat="server">
                                <div id="tag_transact_src_inner" style="width: 1080px; height: 250px;">
                                    <div id="innerbox_MidMain_Trans_new" style="width: 1362px; height: 20px; margin-left: -10px;
                    ...
                    <div id="tag_Exchange_inner_lft" style="width: 1085px; height: 28px;">
                    <div id="tag_transact_lft_in1" style="width: 1085px; height: 20px;">
                     <div id="tag_label_transact_Src" style="width: 110px;">
                                 Invoice No: 
                                </div>
                                <div id="txtcon-m_Exchange" style="width: 170px">
                                  
                                     <asp:TextBox ID="txtpino"  TabIndex="25" CssClass="txtbox_none_Mid_transac_code" runat="server" Width="150" Enabled="false"></asp:TextBox>
                                </div>



                                   <div id="txt_container_Transact_Main_l" style="width: 220px; margin-top: -1px;">
                                <div id="tag_label_transact_Src" style="width: 50px">
                                   Date:
                                </div>
                                <div id="txtcon-m_Exchange" style="width: 85px">
                                    <asp:TextBox ID="txtprodate" runat="server" Width="82px" MaxLength="10" CssClass="txtbox_none_Mid_transac_code"
                                        TabIndex="26"></asp:TextBox>
                                    <asp:MaskedEditExtender ID="MaskedEditExtender1" runat="server" TargetControlID="txtprodate"
                                        Mask="99/99/9999" MaskType="Date" ErrorTooltipEnabled="True" CultureAMPMPlaceholder=""
                                        CultureCurrencySymbolPlaceholder="" CultureDateFormat="" CultureDatePlaceholder=""
                                        CultureDecimalPlaceholder="" CultureThousandsPlaceholder="" CultureTimePlaceholder=""
                                        Enabled="True">
                                    </asp:MaskedEditExtender>
                                    <asp:CalendarExtender ID="CalendarExtender3" runat="server" TargetControlID="txtprodate"
                        ...
                        <div id="tag_transact_lft_in1" style="width: 1085px">
                            <div id="txt_container_Transact_Main_l">
                                ...
                                <div id="txtcon-m_Exchange" > 
                                  <asp:TextBox ID="txtInvoiceNo" runat="server" MaxLength="17" onkeyup="autotab(this);" ClientIDMode="Static" onblur="return ChangeCase(this);"
                                   ...
                                   CssClass="txtbox_none_Mid_transac_Inv_No" TabIndex="27" ></asp:TextBox>
                                </div>
                            </div>
                            <div id="txt_container_Transact_Main_l" style="width: 220px">
                                ...
                                <div id="txtcon-m_Exchange" style="width: 85px">
                                    <asp:TextBox ID="txtDate" runat="server" Width="82px" MaxLength="10" CssClass="txtbox_none_Mid_transac_code"
                            ...
                            <div id="txt_container_Transact_Main_l" style="width: 200px">
                              ...
                              <div id="tag_label_transact_Src" style="width: 80px">
                                ...
                                <div id="txtcon-m_Exchange" style="width: 140px;">
                                    <asp:TextBox ID="txtPONumber"  TabIndex="30" CssClass="txtbox_none_Mid_transac_code" runat="server"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        <%---------------------------------------Row 4-----------------------------------------%>
                        <%--------------------------------------AddRow 1-----------------------------------------%>
                           <div id="tag_transact_lft_in1" style="width: 1085px;height: 28px">
                            <div id="txt_container_Transact_Main_l" style="width: 500px;">
                                <div id="tag_label_transact_Src" style="width: 110px;">
                                   Customer Name:
                                </div>
                                <div id="txtcon-m_Exchange" style="width: 330px;">
                                   <asp:TextBox ID="txt_Cus_name" runat="server" MaxLength="200" onkeyup="autotab(this);"  Width="330px" onkeydown="return false;"
                                    CssClass="txtbox_none_Mid_transac_Inv_No" TabIndex="31" ></asp:TextBox>
                                </div>
                                <div id="magnify_area">
                                            <%-- <a href="#"  class="magnfy" onclick="jQuery('#form1').validationEngine('hideAll');OpenPopupExporter_Master('CUSTOMER'); return false">
                                            </a>--%>
                                             <%-- <a href="#" class="magnfy" onclick="jQuery('#form1').validationEngine('hideAll');OpenPopup_CompanyMaster('Client_Name_Inv');
                                              var a=document.getElementById('val3').value;">  </a>--%>
                                                <a href="#" class="magnfy"  onblur="Load();" onclick="twofunction();" ></a>
                                        </div>
                            </div>
                                ...
                                <div id="txtcon-m_Exchange" style="width: 30px;">
                                    <asp:CheckBox ID="ch_Behalf" runat="server" TabIndex="32" />
                                </div>
                            </div>
                          <div id="magnify_area" style="width: 66px">
                            ...
                            <div id="tag_label_transaction_popup_IGM2_empty">
                             ...
                             <div id="txt_container_Transact_Main_l">
                                <div id="tag_label_transact_Src" style="width: 80px;">
                                    <asp:Label ID="lblinvno" runat="server" Text="Inv No:" Visible="true"></asp:Label>
                                ...
                                <div id="txtcon-m_Exchange" > 
                                  <asp:TextBox ID="txtInvoiceNo1" runat="server" MaxLength="17" Visible="true" 
                                   ...
                                   onkeypress="return Char_Inv(event)"  
                                   CssClass="txtbox_none_Mid_transac_Inv_No" TabIndex="33" Width="106px" ></asp:TextBox>
                                </div>
                            </div>
                        </div>
                           <%--------------------------------------AddRow 2-----------------------------------------%>
                           <div id="tag_transact_lft_in1" style="width: 1085px;">
                            <div id="txt_container_Transact_Main_l">
                                ...
                                <div id="txtcon-m_Exchange">
                                    ...
                                    <asp:DropDownList ID="ddl_state_name" CssClass="listtxt_transac_item_gen_notn" Width="160px" TabIndex="34" ForeColor="Green" runat="server" >
                                     <asp:ListItem Text="" Value=""></asp:ListItem>
                            ...
                            <div id="txt_container_Transact_Main_l" style="width: 220px">
                                ...
                                <div id="txtcon-m_Exchange" style="width: 147px">
                                      <asp:TextBox ID="txt_GSTN_Id" runat="server" MaxLength="17" TabIndex="35" Width="140px" onkeyup="autotab(this);" Font-Size="12px" 
                             ...
                             <%-- <div id="txt_container_Transact_Main_l" style="width: 480px">
                                ...
                                <div id="txtcon-m_Exchange" style="width: 120px">
                                    <asp:TextBox ID="txtAccHead" TabIndex="36" CssClass="txtbox_none_Mid_transac_code" runat="server"></asp:TextBox>
                                </div>
                            ...
                            <div id="txt_container_Transact_Main_l" style="width: 500px;">
                                ...
                                <div id="txtcon-m_Exchange" style="width: 373px;">
                                   <asp:TextBox ID="txt_Party_Add" runat="server" MaxLength="500" 
                                    ...
                                    CssClass="txtbox_none_Mid_transac_Inv_No"  Height="50px" TabIndex="37" ></asp:TextBox>
                                </div>
                            </div>
                        </div>
                      <%--------------------------------------AddRow 6-----------------------------------------%>
                        <div id="tag_transact_lft_in1" style="width: 1085px;height:60px;">
                            <div id="txt_container_Transact_Main_l" style="width: 1080px;">
                                ...
                                <div id="txtcon-m_Exchange" style="width: 380px;">
                                   <asp:DropDownList ID="ddlbank_name" CssClass="listtxt_transac_item_gen_notn"  Width="370px" TabIndex="38" ForeColor="Green" runat="server" >
                            ...
                            <div id="txt_container_Transact_Main_l" style="width: 1080px;">
                                ...
                                <div id="txtcon-m_Exchange" style="width: 380px;">
                                   <asp:DropDownList ID="drpmisc" CssClass="listtxt_transac_item_gen_notn"  Width="370px" TabIndex="39" ForeColor="Green" runat="server" >
                                   <asp:ListItem Text="Non Miscellaneous"></asp:ListItem>
                                   <asp:ListItem Text="Miscellaneous"></asp:ListItem>
                                     </asp:DropDownList>

                                </div>
                                 <div id="tag_transac_lft_Inv_in1" runat="server" style="width: 380px;">
                                  <div id="tag_label_transact_Src" style="width: 80px;">
                                 Category
                                </div>
                            ...
                            <div id="txt_container_Transact_Main_l" style="width: 1080px;">
                                ...
                                <div id="txtcon-m_Exchange" style="width: 380px;">
                                   <asp:TextBox ID="txtNarration" CssClass="txtbox_none_Mid_transac_code"  TabIndex="40" Width="370px" runat="server"></asp:TextBox>
                                ...
                                <div id="txtcon-m_Exchange" style="width: 370px;">
                                   <asp:TextBox ID="txtVerifiedBy" CssClass="txtbox_none_Mid_transac_code"  TabIndex="41" runat="server" Width="150"></asp:TextBox>
                            ...
                            <div id="txt_container_Transact_Main_l" style="width: 1080px;">
                                ...
                                <div id="txtcon-m_Exchange" style="width: 30px;">
                                    <asp:CheckBox ID="Chkdepartment" Enabled="true" AutoPostBack="true" OnCheckedChanged="Chkdepartment_Changed"  TabIndex="42" runat="server" />
                                </div>
                                <div id="txtcon-m_Exchange" style="width: 100px;">
                                    <asp:Label ID="lbldeptapp" runat="server"   TabIndex="43" Text=""></asp:Label>
                                </div>
                                <div id="txtcon-m_Exchange" style="width: 130px;">
                                    <asp:Label ID="lblPendingreason" runat="server" ForeColor="Black">Pending Reason</asp:Label>
                                </div>
                                <div id="txtcon-m_Exchange" style="width: 320px;">
                                    <asp:TextBox ID="txtPendingreason" CssClass="txtbox_none_Mid_transac_code"  TabIndex="44"  runat="server"  Width="300"></asp:TextBox>
                                </div>
                                 <div id="txtcon-m_Exchange" style="width: 180px;">
                                    <asp:Label ID="Lblpending_reason_update" runat="server" ForeColor="Black">Pending Reason Updated</asp:Label>
                                </div>
                                <div id="txtcon-m_Exchange" style="width: 100px;">

                                     <asp:CheckBox ID="chkPendingreasonupdate"  Enabled="true"   TabIndex="45"  runat="server" />
                                </div>
                            </div>
                            <div id="txt_container_Transact_Main_l" style="width: 1080px;">
                                <div id="tag_label_transact_Src" style="width: 150px;">
                                ...
                                <div id="txtcon-m_Exchange" style="width: 30px;">
                                    <asp:CheckBox ID="Chkacc" AutoPostBack="true" Enabled="true"   TabIndex="46" OnCheckedChanged="Chkacc_Changed" runat="server" />
                                </div>
                             ...
                             <div id="txt_container_Transact_Main_l" style="width: 1080px;">
                                ...
                                <div id="txtcon-m_Exchange" style="width: 30px;">
                                    <asp:CheckBox ID="ChkCancelInv" AutoPostBack="false" Enabled="true" TabIndex="47" onchange="Cancelalert()" OnCheckedChanged="ChkCancelInv_Changed" runat="server" />
                                </div>
                                 <div id="txtcon-m_Exchange" style="width: 30px;">
                                    <asp:Label ID="lblcancel" runat="server" Text=""></asp:Label>
                                </div>
                                <div id="txtcon-m_Exchange" style="width: 260px;">
                                    <asp:TextBox ID="txtCancelReason" CssClass="txtbox_none_Mid_transac_code" Width="370px" TabIndex="48" runat="server"></asp:TextBox>
                                </div>
                            </div>
              ...
              <div class="content" id="page-8">
                      <div id="Div2" style="overflow: scroll; height: 400px;
                      width: 1300px; margin-top: -10px; margin-left: -18px;">
                      <asp:GridView ID="gv_Gen_Item_I" runat="server"  EmptyDataText="No Record Found"  ShowHeader="True"
                              ...
                              CssClass="grid-view" AllowPaging="false"
                                 HorizontalAlign="Left" ShowHeaderWhenEmpty="True" Width="1245px"
...
<%--                                   <asp:TemplateField HeaderText="Jobno" HeaderStyle-Font-Bold="true" HeaderStyle-Width="70px"  >
                                   ...
                                   <asp:TemplateField HeaderText="Jobno" HeaderStyle-Font-Bold="true" HeaderStyle-Width="70px"  >
                                        <ItemTemplate>
                                         <asp:TextBox ID="txt_Jobno_I" Text='<%# Bind("JOBNO") %>'  Width="50px"  runat="server" ></asp:TextBox>

<a href="#" onclick="redirectToHouse('<%# Eval("JOBNO") %>')" class="link" style="width: 20px">
    <%# Eval("JOBNO")%>
</a>
<%--  //----------THIRU ---END---INVOICE TO JOB LINK ---18-09-2024--------------------//--%>
                                   ...
                                   <asp:TemplateField HeaderText="Flt/Voy No" HeaderStyle-Font-Bold="true" HeaderStyle-Width="80px">
                                      ...
                                      <asp:TemplateField HeaderText="Ch Wgt" HeaderStyle-Font-Bold="true" HeaderStyle-Width="70px">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Sales" HeaderStyle-Font-Bold="true" HeaderStyle-Width="70px">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txt_Sales"   Text='<%# Bind("SALES") %>'  Width="70px"  runat="server" ></asp:TextBox>
                                        </ItemTemplate>
                                        <ItemStyle Width="30px"/>
                                    </asp:TemplateField>
                                </Columns>
                 ...
                 <%----------------------------Charge Details---------------------------------------------------%>
                    ...
                    <div  class="content"  id="page-7"  style="display:none;height:440px;" >
                           <div id="tag_transac_lft_Item_maindet_Grid_area" style="overflow: auto; height: 30px;
                                width: 1250px; margin-top: -10px;margin-left:-18px;">
                                <asp:GridView ID="GV1" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                    ...
                                    HorizontalAlign="Left" ShowHeaderWhenEmpty="True" Width="1250px" OnRowCreated="GV_RowCreated"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="g" HeaderStyle-Width="110px" HeaderText="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;">
                           ...
                           <div id="tag_transac_lft_Item_maindet_Grid_area" style="overflow: auto; height: 30px;
                                ...
                                <asp:GridView ID="GV" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="a" HeaderText="Charge Name" HeaderStyle-Width="370px">
                                            <ItemStyle CssClass="column_style_left_border_2_new" HorizontalAlign="Left" Width="30px" />
                                        </asp:BoundField>

                                        <asp:BoundField  HeaderText="Description" HeaderStyle-Width="290px">
                                            <ItemStyle CssClass="column_style_left_border_2_new" HorizontalAlign="Left" Width="30px" />
                                        </asp:BoundField>
                                        ...
                                        <asp:BoundField DataField="a" HeaderText="Code" HeaderStyle-Width="92px">
                                            <ItemStyle CssClass="column_style_left_border_2_new" HorizontalAlign="Left" Width="100px" />
                                        </asp:BoundField>
                                         <asp:BoundField DataField="a" HeaderText="" HeaderStyle-Width="20px">
                                            <ItemStyle CssClass="column_style_left_border_2_new" HorizontalAlign="Left" Width="112px" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="d" HeaderText=" Qty" HeaderStyle-Width="35px">
                                            <ItemStyle CssClass="column_style_left_border_2_new" HorizontalAlign="Left" Width="5px" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="d" HeaderText="Cur" HeaderStyle-Width="100px">
                                        ...
                                        <asp:BoundField DataField="e" HeaderText="Rate" HeaderStyle-Width="105px">
                                        ...
                                        <asp:BoundField DataField="g" HeaderText="Amt" HeaderStyle-Width="100px">
                                        ...
                                        <asp:BoundField DataField="g" HeaderText="Amt" HeaderStyle-Width="85px">
                                            <ItemStyle CssClass="column_style_left_border_2_new" HorizontalAlign="Left" Width="120px" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="g" HeaderText=" % " HeaderStyle-Width="50px" >
                                            <ItemStyle CssClass="column_style_left_border_2_new" HorizontalAlign="Left" Width="50px" />
                                        ...
                                        <asp:BoundField DataField="g" HeaderStyle-Width="100px" HeaderText="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;">
                                            <ItemStyle CssClass="column_style_left_border_2_new" HorizontalAlign="Left" />
                                        </asp:BoundField>
                                    </Columns>
                                </asp:GridView>
                            ...
                            <div id="tag_transac_lft_Item_maindet_Grid_area"    style="overflow:auto; height:305px; width:1250px;margin-top:-10px;margin-left:-18px; ">
                             <asp:GridView ID="gv_Chg_Details" runat="server" AllowSorting="True" EmptyDataText="No Record Found"
                                    ...
                                    HorizontalAlign="Left" ShowHeaderWhenEmpty="True" Width="1250px"
                               ...
                               <Columns>
                                     ...
                                     <asp:TemplateField HeaderText="Type" HeaderStyle-Font-Bold="true"  HeaderStyle-Width="30px">
                                       <ItemTemplate>
                                           <asp:DropDownList ID="ddl_tax_nontax" style="pointer-events: none; cursor: default;"  Text='<%# Bind("TAX_NONTAX") %>' MaxLength="20" runat="server"
                                               Width="40px" Height="22px" Font-Size="12px" onchange="Calculation(this)"  CssClass="txtbox_trans_exp_drawback">
                                   ...
                                   <asp:TemplateField HeaderText="HSN_Code" HeaderStyle-Font-Bold="true" HeaderStyle-Width="0px">
                                       <ItemTemplate>
                                           <asp:TextBox ID="txt_HSN_Code" style="pointer-events: none; cursor: default; display:none;"  CssClass="underlined"  Text='<%# Bind("HSN_CODE") %>' runat="server"                                        
                                            Height="20px" Width="0px"  Font-Size="12px"  ></asp:TextBox>
                                       </ItemTemplate>
                                         <ItemStyle Width="0px" />
                                   </asp:TemplateField>
                                    <asp:TemplateField HeaderText="HSN_Code" HeaderStyle-Font-Bold="true" HeaderStyle-Width="50px">
                                     ...
                                     <asp:TemplateField HeaderText="Qty" HeaderStyle-Font-Bold="true" HeaderStyle-Width="30px">
                                       <ItemTemplate> 
                                           <asp:TextBox ID="txtqty"  CssClass="underlined"  Text='<%# Bind("Qty") %>' Height="20px" Width="40px" Font-Size="12px" 
                                    ...
                                    <asp:TemplateField HeaderText="Cur" HeaderStyle-Font-Bold="true" HeaderStyle-Width="50px">
                                     ...
                                     <asp:TemplateField HeaderText="Ex_Rate" HeaderStyle-Font-Bold="true" HeaderStyle-Width="38px">
                                       <ItemTemplate>
                                           <asp:TextBox ID="txt_Ex_Rate" CssClass="underlined"  Text='<%# Bind("EX_RATE") %>' runat="server"                                        
                                            Height="20px" Width="38px" Font-Size="12px"  style="pointer-events: none; cursor: default;text-align:center"  ></asp:TextBox>
                                       </ItemTemplate>
                                         <ItemStyle Width="30px" />
                                   </asp:TemplateField>
                                     ...
                                     <asp:TemplateField HeaderText="Unit Rate" HeaderStyle-Font-Bold="true" HeaderStyle-Width="65px">
                                      ...
                                      <asp:TemplateField HeaderText="Disc-Rate" HeaderStyle-Font-Bold="true" HeaderStyle-Width="20px">
                                       <ItemTemplate> 
                                           <asp:TextBox ID="txtDiscountRate" CssClass="underlined"  Text='<%# Bind("DISC_RATE") %>'    BackColor="#FFCCCB"
                                           onblur="extractNumber(this,3,false);" onkeyup="extractNumber(this,3,false);return Clear_Dot(this);"  onkeypress="return blockNonNumbers(this, event, true, false);"
                                      ...
                                      <asp:TemplateField HeaderText="Disc-Amt" HeaderStyle-Font-Bold="true" HeaderStyle-Width="55px">
                                       <ItemTemplate > 
                                           <asp:TextBox ID="txtDiscount_AMT" CssClass="underlined"   Text='<%# Bind("DISC_AMT") %>'   BackColor="WhiteSmoke"
                                           onblur="extractNumber(this,3,false);" onkeyup="extractNumber(this,3,false);return Clear_Dot(this);"  onkeypress="return blockNonNumbers(this, event, true, false);"
                                   ...
                                   <asp:CommandField ShowDeleteButton="True" ControlStyle-Font-Bold="true"  DeleteText="Delete"  ControlStyle-Font-Size="Small"   />
                               ...
                               <div id="txtcon-m_Exchange" style="width: 120px">
                                   <asp:TextBox ID="txt_Expense_Amt" runat="server" Font-Bold="true" MaxLength="17"
                                       ...
                                       TabIndex="108"></asp:TextBox>
                                        ...
                                        <a id="Link_Container" runat="server" href="javascript:open_cost_sheet()">
                  ...
                  <div id="innerbox_MidMain_bot_transact" runat="server" style="height:20px;">
                    <div id="innerbox_transac_bot_inn" style="width:1050px">
                        ...
                        <div id="editbu">
                            <asp:Button ID="btnDelete" runat="server" TabIndex="121" CausesValidation="false" Enabled="false"
              ...
              document.getElementById('btn').click();
                       ...
                       <div id="editbu" style="width:10px;"></div>
                        <div id="editbu" style="padding-top:5px;">
                            <asp:Button ID="btnrpt" runat="server" tabindex="125" Visible="false" Text="Tax Bill" OnClientClick="return GST_Billing_Job_Rpt('Ti');"  /> <%--OnClientClick="return Import_Billing_Job_Rpt('B');"--%> 
                        </div>
                          <div id="editbu" style="width:10px;"></div>
                        <div id="editbu" style="padding-top:5px;">
                            <asp:Button ID="btnprorpt" runat="server" tabindex="126" Visible="false" Text="Pro Inv Bill" OnClientClick="return GST_Billing_Job_Rpt('Pi');"  /> <%--OnClientClick="return Import_Billing_Job_Rpt('B');"--%> 
                        </div>
                        <div id="editbu" style="width:10px;"></div>
                        <div id="editbu" style="padding-top:5px;">
                          <asp:Button ID="btn_EInvoice" runat="server" Visible="false" Text="E-Invoice" tabindex="125" OnClick="btn_Generate_EInvoice_Click" /> 
                        </div>
                        <div id="editbu" style="visibility:hidden;">
                            <asp:Button ID="btnJSON_Post" runat="server"  Text="E-Invoice" OnClick="btnJSON_Post_Click"
                                 TabIndex="128" />
                        </div>
                        <div id="editbu" style="width:10px;"></div>
                        <div id="editbu" style="padding-top:5px;">
                            <asp:Button ID="btnemail" runat="server" tabindex="127" Visible="false" Text="Email"  OnClientClick="return GST_Billing_Job_Rpt_mail('Ti');"/>
                        </div>
                    </div>
            ...
            <asp:HiddenField ID="hdnbranch" runat="server" />
             <asp:HiddenField ID="hdnstate" runat="server" />
               <asp:HiddenField ID="Hidden_val" runat="server" />
                 <asp:HiddenField ID="hdnTransHistory" runat="server" />
                <asp:HiddenField ID="hdn_add" runat="server" />
                 <asp:HiddenField ID="hdn_remove" runat="server" />
 <asp:HiddenField ID="hdn_load" runat="server" />
  <asp:HiddenField ID="hdn_approved" runat="server" />
  <asp:HiddenField ID="hdn_deppart" runat="server" />
   <asp:HiddenField ID="hdn_cancel" runat="server" />
 <asp:HiddenField ID="hdn_alt_inv" runat="server" />
 <asp:HiddenField ID="hdn_mawbno" runat="server" />
 <asp:HiddenField ID="hdn_hawblno" runat="server" />
 <asp:HiddenField ID="hdn_chargename" runat="server" />
 <asp:HiddenField ID="hdn_qty" runat="server" />
 <asp:HiddenField ID="hdn_exrate" runat="server" />
 <asp:HiddenField ID="hdn_unitrate" runat="server" />
 <asp:HiddenField ID="hdn_billto" runat="server" />
 <asp:HiddenField ID="hdn_cusname" runat="server" />
 <asp:HiddenField ID="hdn_einvoice" runat="server" />
                  <asp:HiddenField ID="hdn_rowdelete" runat="server" />
                  <asp:HiddenField ID="hdn_item" runat="server" />
 <asp:HiddenField ID="hdn_charge" runat="server" />
        ...
        $(function () {
            $("#txt_Jobno").autocomplete({
                source: function (request, response) {
                    ...
                    var ck_from_cha = document.getElementById("Chk_Cha").checked;
                   
                  
                    $.ajax({

                        url: "../AutoComplete_Pages/Auto_Complete_Searching.asmx/Imp_Exp_Billing_Search_Db",
                        data: "{ 'mail': '" + request.term + "','Imp_Exp': '" + Rd_Imp_Exp + "','Cus_name': '" + ddlCus_name + "' ,'Branch_No': '" + ddlbranch_No + "','Jobno_list': '" + txt_Jobno_list + "','ddl_tr_mode': '" + ddl_tr_mode + "','branch': '" + branch + "','type': '" + type + "' ,'Working': '" + Working + "','ck_from_cha': '" + ck_from_cha + "' }",
                        dataType: "json",
                        type: "POST",
                        contentType: "application/json; charset=utf-8",
...
//                                txt_Ex_Rate[document.getElementById("Hd_row_id").value].value = "1"
//                            }
                        }
                        if (before == 'N') {
...
//                        }
                        ...
                        if (res == 'N') {
                            ...
                            if (txtIGST_RATE_OP[document.getElementById("Hd_row_id").value].value == '' || txtIGST_RATE_OP[document.getElementById("Hd_row_id").value].value == '0') {
                                txtIGST_RATE_OP[document.getElementById("Hd_row_id").value].value = tempCGST_RATE.toString()
                            }
         ...
         function CallSuccess_Cha_exrate(res, destCtrl) {
             ...
             if (res != '') {
                 ...
                 if (GST_State.val() != 'IO') {
                     ...
                     var ck_from_cha = true;
                     ck_from_cha = document.getElementById("Chk_Cha").checked;
                     var type = $('#<%= ddlType.ClientID %>').val();
                   
                     if (type == 'CLEARING' && ck_from_cha === true) {
                         exrate[document.getElementById("Hd_row_id").value].value = data.toString();
                     }
...
//                     }
  ...
  <script type="text/javascript">
      $(document).ready(function () {
          ...
          //-----------THIRU---------start---DISCOUNT ---09-11-2024--------I-----------------------------------
          $('[id*=txtDiscountRate]').focus(function () {
          ...
          $('[id*=txtDiscountRate]').change(function () {

              Tax_Cal();

          });
          $('[id*=txtDiscountRate]').keyup(function () {

              Tax_Cal();

          });
          $('[id*=txtDiscountRate]').keydown(function () {

              Tax_Cal();

          });

          $('[id*=txtDiscount_AMT]').focus(function () {
          ...
          $('[id*=txtDiscount_AMT]').change(function () {

              Tax_Cal();

          });
          $('[id*=txtDiscount_AMT]').keyup(function () {

              Tax_Cal();

          });
          $('[id*=txtDiscount_AMT]').keydown(function () {

              Tax_Cal();

          });

          //-----------THIRU------ ---end---DISCOUNT ---09-11-2024--------I-----------------------------------
  ...
  <script type="text/javascript">
      ...
      function Tax_Cal() {
          ...
          var txtamt = $("[id*=txtamt]")
              ...
              var DISC_RATE = $("[id*=txtDiscountRate]")
              var DISC_AMT = $("[id*=txtDiscount_AMT]")
                      ...
                      if (!isNaN(txtamt[index].value) && txtamt[index].value.length != 0) {
                          ...
                          if (tax_type[index].value == 'T' && BillType != 'Sez') {
                              ...
                              if (GST_State.val() == 'L' && CGST_Rate[index].value != '0') {
                                  ...
                                  //---------thiru---start---discount---09-11-2024---
                                  if (DISC_RATE[index].value != '') {
                                      DISC_AMT[index].value = (parseFloat(txtamt[index].value) * DISC_RATE[index].value / 100.00).toFixed(2);

                                      txtamt[index].value = txtamt[index].value - DISC_AMT[index].value;
...
//          }
    ...
    <script language="javascript">
        ...
        function open_cost_sheet() {
            var Jobno = '<%= Session["JOBNO"].ToString() %>';
            var Type = '<%= Session["TYPE"].ToString() %>';
            var Imp = '<%= Session["IMP_EXP"].ToString() %>';
            var Mode = '<%= Session["MODE"].ToString() %>';

            w = '1000';
            h = '290';
            LeftPosition = (screen.width / 2) - ((w / 2) + 80);
            TopPosition = (screen.width / 2) - ((h / 2) + 500);
            settings = 'width=' + w + ',height=' + h + ',top=' + TopPosition + ',left=' + LeftPosition + ',resize=0, scrolling=0';

            adcodewindow = dhtmlmodal.open('ClientMaster', 'iframe', '../Accounts/Cost_Sheet.aspx?JOBNO=' + Jobno + '&TYPE=' + Type + '&IMP_EXP=' + Imp + '&Mode=' + Mode + '', '', settings)
        ...
        function Jobno_Inv() {
            ...
            document.getElementById("txt_Jobno").value = document.querySelector('#ddlJobno_N').value;
        }
    ...
    <script type="text/javascript">
        ...
        function redirectToHouse(JOBNO) {
            var Jobno = JOBNO;
            var Type = '<%= Session["TYPE"].ToString() %>';
            var Imp = '<%= Session["IMP_EXP"].ToString() %>';
            var Mode = '<%= Session["MODE"].ToString() %>';
            var Group_Id = '<%= Session["GROUP_ID"].ToString() %>';
            var JOBID = 'JOBID';


            if (Jobno != '' && Type != 'OTHERS' && Imp == 'I' && Mode == 'Air') {
                var width = 1270;
                var height = 590;
                var left = (window.screen.width - width) / 2.1;
                var top = (window.screen.height - height) / 3;
                var settings = 'width=' + width + ',height=' + height + ',left=' + left + ',top=' + top;
                window.open('../Transaction_Import/Import_Planning_Air.aspx?INVJobno=' + Jobno + '&Type=' + Type + '&Mode=' + Mode + '&Group_Id=' + Group_Id + '&JOBID=' + JOBID, '', settings);
            }
            if (Jobno != '' && Type == 'OTHERS' && Imp == 'I' && Mode == 'Air') {
                ...
                var top = (window.screen.height - height) / 3;
                var settings = 'width=' + width + ',height=' + height + ',left=' + left + ',top=' + top;
                window.open('../Transaction_Import/Import_Planning_Air_Vas.aspx?INVJobno=' + Jobno + '&Type=' + Type + '&Mode=' + Mode + '&Group_Id=' + Group_Id + '&JOBID=' + JOBID, '', settings);
            }
            if (Jobno != '' && Type != 'OTHERS' && Imp == 'I' && Mode == 'Sea') {
                ...
                var top = (window.screen.height - height) / 3;
                var settings = 'width=' + width + ',height=' + height + ',left=' + left + ',top=' + top;
                window.open('../Transaction_Import/Import_Planning_Sea.aspx?INVJobno=' + Jobno + '&Type=' + Type + '&Mode=' + Mode + '&Group_Id=' + Group_Id + '&JOBID=' + JOBID, '', settings);
            ...
            if (Jobno != '' && Type == 'OTHERS' && Imp == 'I' && Mode == 'Sea') {
                ...
                var top = (window.screen.height - height) / 3;
                var settings = 'width=' + width + ',height=' + height + ',left=' + left + ',top=' + top;
                window.open('../Transaction_Import/Import_Planning_Sea_Vas.aspx?INVJobno=' + Jobno + '&Type=' + Type + '&Mode=' + Mode + '&Group_Id=' + Group_Id + '&JOBID=' + JOBID, '', settings);
            }
            if (Jobno != '' && Type != 'OTHERS' && Imp == 'E' && Mode == 'Air') {
                var width = 1270;
                var height = 590;
                var left = (window.screen.width - width) / 2.1;
                var top = (window.screen.height - height) / 3;
                var settings = 'width=' + width + ',height=' + height + ',left=' + left + ',top=' + top;
                window.open('../Transaction_Export/Export_Air_Planning.aspx?INVJobno=' + Jobno + '&Type=' + Type + '&Mode=' + Mode + '&Group_Id=' + Group_Id + '&JOBID=' + JOBID, '', settings);
            }
            if (Jobno != '' && Type == 'OTHERS' && Imp == 'E' && Mode == 'Air') {
                var width = 1270;
                var height = 590;
                ...
                var top = (window.screen.height - height) / 3;
                var settings = 'width=' + width + ',height=' + height + ',left=' + left + ',top=' + top;
                window.open('../Transaction_Export/Export_Air_Planning_Vas.aspx?INVJobno=' + Jobno + '&Type=' + Type + '&Mode=' + Mode + '&Group_Id=' + Group_Id + '&JOBID=' + JOBID, '', settings);
            }
            if (Jobno != '' && Type != 'OTHERS' && Imp == 'E' && Mode == 'Sea') {
                ...
                var top = (window.screen.height - height) / 3;
                var settings = 'width=' + width + ',height=' + height + ',left=' + left + ',top=' + top;
                window.open('../Transaction_Export/Export_Planning_Sea.aspx?INVJobno=' + Jobno + '&Type=' + Type + '&Mode=' + Mode + '&Group_Id=' + Group_Id + '&JOBID=' + JOBID, '', settings);
            ...
            if (Jobno != '' && Type == 'OTHERS' && Imp == 'E' && Mode == 'Sea') {
                ...
                var top = (window.screen.height - height) / 3;
                var settings = 'width=' + width + ',height=' + height + ',left=' + left + ',top=' + top;
                window.open('../Transaction_Export/Export_Planning_Sea_Vas.aspx?INVJobno=' + Jobno + '&Type=' + Type + '&Mode=' + Mode + '&Group_Id=' + Group_Id + '&JOBID=' + JOBID, '', settings);
            }
        }
