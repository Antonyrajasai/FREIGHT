<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReceiptEntry.aspx.cs" Inherits="Accounts_ReceiptEntry" %>
                            ...
                            <div style="width: 1400px; height: 30px">
                                <div id="txt_container_Transact_Main_l" style="width: 1280px;">
                                    ...
                                    <div id="txtcon-m_Exchange" style="width: 360px;">
                                        <asp:DropDownList ID="ddlCustomername" class="chosen-select-deselect" Style="width: 355px;"
                                            data-placeholder="Choose a Customer name" onchange="Vendor_Details();"
                                    ...
                                    <div id="txtcon-m_Exchange" style="width: 230px">
                                          ...
                                          <asp:DropDownList ID="ddlCustomerBranch" runat="server" 
...
<%--
                                        <asp:DropDownList ID="ddlCustomerBranch" class="chosen-select-deselect" 
...
<%--
            ...
            margin-top: -40px;">
            <div id="pop_text_area_transac_popup_inn_container_export" style="height: 150px;
                margin-top: 30px;">
                <div id="tag_transact_src_inner" style="width: 1280px">
                    <div id="tag_Exchange_inner_lft" style="width: 1280px">
                        ...
                        <div id="tag_transact_lft_in1" style="width: 1280px; height: 30px;">
                        <div id="tag_label_transact_Src" style="width: 90px;">
                                        Charge Name
                                    </div>
                                    <div id="txtcon-m_Exchange" style="width: 200px;">
                                    ...
                                    <div id="txtcon-m_Exchange"  style="width: 20px;">
                                    </div>
                            ...
                            <div id="txt_container_Transact_Main_l" style="width: 250px;">
                                <div id="tag_label_transact_Src" style="width: 150px;color: gray; font-weight: bold;">
                                  Already Received Amt :
                                </div>
                                <div id="txtcon-m_Exchange" style="width: 100px;">
                        ...
                        <div id="tag_transact_lft_in1" style="width: 1320px">
                        ...
                        <div id="txt_container_Transact_Main_l" style="width: 220px;">
                            ...
                            <div id="txt_container_Transact_Main_l" style="width: 230px;">
                               ...
                               <div id="txt_container_Transact_Main_l" style="width: 230px;">
                                <div id="tag_label_transact_Src" style="width: 70px; font-weight: bold;">
                                  TDS Amt :
                                </div>
                                <div id="txtcon-m_Exchange" style="width: 100px;">
                                        <asp:TextBox ID="txttdsamt" Width="90px" Font-Bold="true" ForeColor="Maroon"
                                        TabIndex="42" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);return Clear_Dot(this);"
                                        onkeypress="return blockNonNumbers(this, event, true, false);" autocomplete="off"
                                        CssClass="txtbox_none_Mid_transac_code" runat="server"></asp:TextBox>
                                </div>
    ...
    <div id="pop_text_area_transac_popup_inn_container_IGM_gateway_grid" style="margin-top: 0px;
        ...
        <div id="pop_text_area_transac_popup_inn_container_IGM_Container2_grid_gateway" runat="server"
            ...
            <asp:GridView ID="gv_Ch" runat="server" DataKeyNames="RC_ID,RECEIPT_NO" EmptyDataText="NO RECORD FOUND"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="RECEIVABLE_AMT" HeaderText="Receivable Amt">
                        <ItemStyle CssClass="column_style_left5" Width="100px" />
                    </asp:BoundField>
                    <asp:BoundField DataField="WRITE_OFF_AMT" HeaderText="Write off Amt">
                        <ItemStyle CssClass="column_style_left5" Width="50px" />
                    </asp:BoundField>
                      <asp:BoundField DataField="TDS_AMT" HeaderText="TDS Amt">
                        <ItemStyle CssClass="column_style_left5" Width="50px" />
                    </asp:BoundField>
                    ...
                    <asp:BoundField DataField="REMARKS" HeaderText="">
                        ...
                        <ItemStyle CssClass="hideGridColumn" />
                          ...
                          <asp:BoundField DataField="Mode" HeaderText="">
                        <HeaderStyle CssClass="hideGridColumn" />
                        <ItemStyle CssClass="hideGridColumn" />
                    </asp:BoundField>
                ...
                <asp:HiddenField ID="hdncusdate" runat="server" />
                 <asp:HiddenField ID="hdnstatename" runat="server" />
                  <asp:HiddenField ID="hdnddljob" runat="server" />
                   ...
                   <asp:HiddenField ID="hdn_inv_amount" runat="server" />
                    <asp:HiddenField ID="hdn_Already_amount" runat="server" />
                     <asp:HiddenField ID="hdn_Bal_amount" runat="server" />
                      <asp:HiddenField ID="hdn_Rev_amount" runat="server" />
    ...
    <script src="../Dropdown/chosen.proto.min.js" type="text/javascript"></script>
     ...
     <script type="text/javascript">
         ...
         function Vendor_Details() {
             ...
             var Vendor = document.getElementById("ddlCustomername").value;
         ...
         function CallSuccess_Ven_Det(res) {
             ...
             document.getElementById("ddlCustomerBranch").options.length = 0;
             var dropdown = document.getElementById("ddlCustomerBranch");
         ...
         function Vendor_Branch() {
             var VendorBranch = document.querySelector('#ddlCustomerBranch').value;
...
//         window.onload = Job_Details();
         function Job_Details() {
             var Vendor = document.getElementById("ddlCustomername").value;
             var Vendor_Branch = document.getElementById("ddlCustomerBranch").value;
...
//             var bal = s[4];
             document.getElementById('lbl_Cus_Name').innerHTML = cus_name;
