<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/eRoyalFreightMasters.master"
    AutoEventWireup="true" CodeFile="ReceiptEntrySearch.aspx.cs" Inherits="ReceiptEntrySearch" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="innerbox_MidMain" style="height: 105px;">
        <div id="tag_srcinner1">
            <div id="newbu">
                <input type="submit" value="Submit" class="new" onclick="open_Receipt_New('New'); return false" />
            </div>
            ...
            <div id="editbu" style="padding-top:3px;">
                      ...
                      <asp:LinkButton ID="LnkReceipt" runat="server" Height="28px" Width="108px"  OnClientClick="EXcelRecipt()">Receivable Amount</asp:LinkButton>
                </div>
    ...
    <div id="innerbox_MidMain_Grid" style="height: 580px; margin-top: -13px;">
        ...
        <div id="Main_Grid_Container" runat="server">
            <asp:GridView runat="server" ID="gvdetails" EmptyDataText="NO RECORD FOUND" AutoGenerateColumns="false"
               ...
               OnRowCreated="gvdetails_RowCreated" OnRowDataBound="gvdetails_RowDataBound" DataKeyNames="R_ID,RECEIPT_NO"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="RECEIPT_NO" HeaderText="Receipt No" HeaderStyle-HorizontalAlign="Left"
                        HeaderStyle-Width="90px">
                        <ItemStyle CssClass="column_style_left5" HorizontalAlign="Left" Width="90px" Font-Size="12px" />
                    </asp:BoundField>

                    <asp:BoundField DataField="RECEIPT_DATE" HeaderText="Receipt Date"  HeaderStyle-Width="90px">
                            <ItemStyle CssClass="column_style_left5" HorizontalAlign="Center" Width="90px" Font-Size="12px" />
                    </asp:BoundField>
                   
                    <asp:BoundField DataField="PARTY_NAME" HeaderText="Customer Name" HeaderStyle-Width="250px">
 ...
 <script src="../js/Import_Jscript/Imp_MIS.js" type="text/javascript"></script>
    ...
    <script type="text/javascript">
     ...
     function EXcel() {
                ...
                var Vendorname = $('#<%= ddlVendorname.ClientID %>').val();
                var totalRows = $("#<%=gvdetails.ClientID %> tr").length;
                var lastProductId = $("#<%=gvdetails.ClientID %> tr:last").children("td:first").html();
//               var Type = 'R';
                win = window.open('../FlatFile/MIS_report_1.aspx?Receipt_Entry_Data=Yes&&txt_Payment_No=' + txt_Payment_No + '&&Fromdate=' + Fromdate + '&Todate=' + Todate + '&Month=' + Month + '&Vendorname=' + Vendorname + '', 'ndf');

                Loading_HideImage();
            }

            function EXcelRecipt() {
                ...
                var Todate = '';
                var Month = '';
                win = window.open('../FlatFile/MIS_report_1.aspx?Receivable_Amount_Data=Yes&&txtsearch=' + txtsearch + '&&Fromdate=' + Fromdate + '&Todate=' + Todate + '&Month=' + Month + '', 'ndf');
