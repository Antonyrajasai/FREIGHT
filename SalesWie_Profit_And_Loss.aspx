<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SalesWie_Profit_And_Loss.aspx.cs" MasterPageFile="~/MasterPage/eRoyalFreightMasters.master" Inherits="Accounts_SalesWie_Profit_And_Loss" %>
...
<div id="tag_label_transact_Src" style="width: 85px;">
                            ...
                            <asp:Label ID="lblList" runat="server" Text="SalesName"></asp:Label>
                            </div>
                              <div id="tag_label_transact_Src" style="width: 100px; display:none">
                                     ...
                                     <asp:TextBox ID="txtSales" runat="server"  ClientIDMode="Static"
                                    CssClass="txtbox_none" Width="150px"  TabIndex="1" Height="21px"
                                       ontextchanged="txtsearch_TextChanged"></asp:TextBox>
                    ...
                    <div id="txtcon-m_transaction_code"style="width: 175px;"  >
                                   ...
                                   <asp:DropDownList ID="ddlCategory" runat="server" TabIndex="4" style="width: 150px;">
                                      <asp:ListItem></asp:ListItem>
                    ...
                    <div id="txtcon-m_transaction_code"style="width: 100px;"  >
                             ...
                             <div id="tag_label_transact_Src"style="width: 30px;">
                            </div>
                              <div id="tag_label_transact_Src" style="width: 60px;">
                               Type</div>
                        <div id="txtcon-m_transaction_code"style="width: 100px;"  >
            ...
            <div id="Main_Grid_Container" runat="server" >  
                <asp:GridView runat="server" ID="gvdetails" EmptyDataText="NO RECORD FOUND" AutoGenerateColumns="false"
                    ...
                    <asp:BoundField DataField="JOBNO">
                        ...
                        <asp:BoundField DataField="SALES_BY" HeaderText="Sales" >
                            <ItemStyle CssClass="column_style_left5"  />
                        </asp:BoundField>
                          <asp:BoundField DataField="CLIENTNAME" HeaderText="Client" >
                            <ItemStyle CssClass="column_style_left5"  />
                        </asp:BoundField>
                        <asp:BoundField DataField="SUPLIER_NAME" HeaderText="Shipper" >
                            <ItemStyle CssClass="column_style_left5"  />
                        </asp:BoundField>
  ...
  <script type="text/javascript">
      ...
      function EXcel() {
        ...
        win = window.open('../FlatFile/MIS_report_1.aspx?Sales_PersonWise_Profit_loss=Yes &&Fromdate=' + Fromdate + '&&Todate=' + Todate + '&&jobtype=' + jobtype + '&&category=' + category + '&&mode=' + mode + '&&Sales=' + Sales + '&&SearchCa=' + SearchCa + '', 'ndf');
          Loading_HideImage();
      }


      $(function () {
          $("#txtSales").autocomplete({
              source: function (request, response) {
                              $.ajax({
                      url: "../AutoComplete_Pages/Auto_Complete_Searching.asmx/Client_PF_List",
                      data: "{ 'mail': '" + request.term + "','Aflags': '" + document.getElementById("<%=ddlSearch.ClientID %>").value + "'}",
                      dataType: "json",
                      type: "POST",
                      contentType: "application/json; charset=utf-8",
                      dataFilter: function (data) { return data; },
                      ...
                      success: function (data) {
                          response(data.d);
                          if (data.d == '') {
                              jQuery('#txtSales').validationEngine('showPrompt', 'Incorrect', 'error', 'topRight', true);
                          }
                          else {
                              jQuery('#txtSales').validationEngine('hidePrompt', '', 'error', 'topRight', true);
                          }
                      },
