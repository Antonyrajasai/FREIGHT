...
public partial class Accounts_Sales_Person_wise_Volume_Report : ThemeClass
{
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        erm.jobno = "";
        erm.JOBTYPE = ddlType.SelectedValue.ToString();

        erm.CATEGORY = ddlCategory.SelectedValue.ToString();

        erm.MODE = ddlMode.SelectedValue.ToString();
        erm.SearchCat = ddlSearch.SelectedValue.ToString();
        erm.BUYER_NAME = txtAgent.Text;

        dss = erm.RetrieveAll_Agent_wise_Volume_Report();
        ...
        //if (ddlSearch.SelectedValue == "CHA")
        //{
        ...
        //}
        //else if (ddlSearch.SelectedValue == "Origin")
        //{
        ...
        //    //gvdetails.Columns[7].Visible = false;
        //}
        //else if (ddlSearch.SelectedValue == "Consol")
        //{
        ...
        //    //gvdetails.Columns[7].Visible = false;
        //}
        //else if (ddlSearch.SelectedValue == "Other")
        //{
        ...
        //    //gvdetails.Columns[7].Visible = false;
        //}
        //else if (ddlSearch.SelectedValue == "Client")
        //{
        ...
        //    //gvdetails.Columns[7].Visible = false;
        //}
        if (ddlSearch.SelectedValue == "Sales")
        {
    ...
    private void Load_Grid()
    {
        ...
        if (txtAgent.Text != "NULL" && txtAgent.Text != string.Empty)
        {
            erm.BUYER_NAME = txtAgent.Text;
        }
        ...
        ds1 = erm.RetrieveAll_Agent_wise_Volume_Report();
    ...
    public void gridbind(int currentPageNumber1)
    {
        ...
        gvdetails.DataSource = erm.RetrieveAll_Agent_wise_Volume_Report();
