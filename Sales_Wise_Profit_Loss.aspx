<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Sales_Wise_Profit_Loss.aspx.cs" MasterPageFile="~/MasterPage/eRoyalFreightMasters.master" Inherits="Accounts_Sales_Wise_Profit_Loss" %>
...
<div id="tag_label_transact_Src" style="width: 85px;">
                            ...
                            <asp:Label ID="lblList" runat="server" Text="ListBy"></asp:Label>
                            </div>
