...
public partial class Accounts_Sales_Wise_Profit_Loss : System.Web.UI.Page
{
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        else if (ddlSearch.SelectedValue == "Shipper")
        {
        ...
        else if (ddlSearch.SelectedValue == "Consignee")
        {
        ...
        else if (ddlSearch.SelectedValue == "Airline")
        {
        ...
        else if (ddlSearch.SelectedValue == "Agent")
        {
